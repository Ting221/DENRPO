function S = DENRPO4_run(data,lambda,gamma,rho,eta,tao,win_size)
%% Statement
%{ 
...
based on the Alternating Direction Method of Multipliers. Based on some empirical financial principles 
...
for t=2:T
    ...
    s_tcut1=S(t-1);
    b_t=DENRPO4_fun(data,t-1,b_tcut1_hat,rho,lambda,eta,tao,win_size); 
    b_t=b_t/norm(b_t,1);
